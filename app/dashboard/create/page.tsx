            ...
            <div className="p-6 w-full max-w-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            className="w-full h-12 px-4 text-lg rounded bg-background text-foreground border border-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
                            value={title}
                    ...
                    <div>
                        ...
                        <textarea
                            className="w-full h-32 px-4 py-2 text-lg rounded bg-background text-foreground border border-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
                            value={description}
                        ...
                        {previewURL && (
                            <div className="mt-4">
                                ...
                                <img
                                    src={previewURL}
                                    alt="Preview"
                                    className="w-full h-auto rounded border border-foreground"
                                />
                            </div>
                        )}
                    </div>
